<template>
  <div class="container">
    <div class="title">
      ...
      <div class="rating" v-if="mySelf">
        <component :is="ratingComponent" :id="id" :type="type"></component>
      </div>
    </div>
...
@import url(./citizenInteraction.less);
</style>
...
<script lang="ts" src="./citizenInteraction.ts" />
